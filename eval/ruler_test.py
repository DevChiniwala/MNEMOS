...
# -*- coding: utf-8 -*-
"""
Mnemos + RULER evaluation script.
...
def process_sample(
    ...
    try:
        ...
        try:
            ...
            print(f"Gold answers: {ground_truth_outputs}")
            print(f"Evaluation: {'âœ“ correct' if is_correct else 'âœ— incorrect'}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Mnemos + RULER evaluation")
