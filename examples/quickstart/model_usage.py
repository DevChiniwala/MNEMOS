"""
Examples of using different model backends with Mnemos (OpenRouter API or local VLLM).
"""
...
def openrouter_example():
    ...
    print(f"âœ… Built {len(memory_state.abstracts)} memory abstracts\n")
...
def custom_endpoint_example():
    ...
    print("âœ… Custom endpoint configured")
...
def vllm_example():
    ...
    try:
        ...
        print(f"âŒ Local model error: {e}")
...
def main():
    """Main entry."""
    print("Mnemos Model Usage Examples")
    ...
    print("\nSummary")
    if os.getenv("OPENROUTER_API_KEY"):
        print("âœ… OpenRouter API: great for rapid prototyping and deployment")
    print("âœ… Custom endpoints: useful for OpenAI-compatible providers")
    print("âœ… VLLM local models: good for privacy/offline")

    print("\nMore info:")
    print("  - See eval/ for evaluation examples")
    print("  - See mnemos/generator/ for generator implementations")
