...
from mnemos.schemas.page import Page
...
def test_ttl_memory_store():
    ...
    try:
        ...
        # Test 3: TTL Cleanup
        print("\nâœ“ Test 3: TTL Cleanup (2-second TTL)")
...
def main():
    ...
    print("â•”" + "=" * 58 + "â•—")
    print("â•‘" + " " * 58 + "â•‘")
    print("â•‘" + "  TTL Feature Validation Test Suite".center(58) + "â•‘")
    print("â•‘" + " " * 58 + "â•‘")
    print("â•š" + "=" * 58 + "â•")
    ...
    try:
        ...
        print("TEST SUMMARY")
        print("=" * 60)
        print(f"TTLMemoryStore: {'âœ… PASS' if mem_result else 'âŒ FAIL'}")
        print(f"TTLPageStore:   {'âœ… PASS' if page_result else 'âŒ FAIL'}")
        print("=" * 60)
        
        if mem_result and page_result:
            print("\nðŸŽ‰ ALL TESTS PASSED!")
            print("\nKey Features Verified:")
            print("  âœ“ TTL-aware storage with timestamp tracking")
            print("  âœ“ Auto and manual cleanup")
            print("  âœ“ Statistics tracking")
            print("  âœ“ Configurable TTL periods")
            return 0
        else:
