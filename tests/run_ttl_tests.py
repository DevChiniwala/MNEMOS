...
Bypasses mnemos/__init__.py to avoid Java dependency
"""
...
# Get base path
base_path = '/home/zsheriff/my-dev/Nuha_tool_context_framework/clone_mnemos/mnemos/mnemos/schemas'
...
print('â•”' + '=' * 78 + 'â•—')
print('â•‘' + ' TTL FEATURE COMPREHENSIVE VALIDATION TEST SUITE '.center(78) + 'â•‘')
print('â•š' + '=' * 78 + 'â•')
print()
...
def run_test(name, test_func):
    ...
    try:
        ...
        print(f'âŒ FAIL: {name} - {e}')
        results.append((name, False, str(e)))
        return False

# TTLMemoryStore Tests
print('\nðŸ“¦ TTLMemoryStore Tests')
print('-' * 80)
...
if passed == total:
    print('\nðŸŽ‰ ALL TESTS PASSED! TTL FEATURE FULLY VALIDATED!')
    exit(0)
else:
