...
This package implements the core mechanics behind Mnemos:
...
- `mnemos/README.md` explains how the Python package works internally.

If you are writing code inside `mnemos/`, this is the one to read first.
...
<p align="center">
  <img src="../assets/readme/mnemos_package_images/01_package_architecture_hero.png" alt="Package architecture hero" width="32%" />
  <img src="../assets/readme/mnemos_package_images/02_memory_write_lifecycle.png" alt="Memory write lifecycle" width="32%" />
  <img src="../assets/readme/mnemos_package_images/03_research_runtime_loop.png" alt="Research runtime loop" width="32%" />
</p>
<p align="center">
  <img src="../assets/readme/mnemos_package_images/04_retrieval_scoring_math.png" alt="Retrieval scoring math" width="32%" />
  <img src="../assets/readme/mnemos_package_images/05_graph_semantics_crud.png" alt="Graph semantics and CRUD" width="32%" />
  <img src="../assets/readme/mnemos_package_images/06_production_readiness_dashboard.png" alt="Production readiness dashboard" width="32%" />
</p>

### 3.2 Package SVG Set (6 animated technical diagrams)

1) Package architecture map  
![Package architecture](../assets/readme/mnemos_package_svgs/01_package_architecture.svg)

2) Memory write sequence  
![Memory write sequence](../assets/readme/mnemos_package_svgs/02_memory_write_sequence.svg)

3) Research runtime sequence  
![Research runtime sequence](../assets/readme/mnemos_package_svgs/03_research_runtime_sequence.svg)

4) Schema relations map  
![Schema relations](../assets/readme/mnemos_package_svgs/04_schema_relations.svg)

5) Retrieval scoring engine  
![Retrieval scoring engine](../assets/readme/mnemos_package_svgs/05_retrieval_scoring_engine.svg)

6) Graph semantics and CRUD  
![Graph semantics and CRUD](../assets/readme/mnemos_package_svgs/06_graph_semantics_crud.svg)

---

### 4. Package Scope and Philosophy

`mnemos/` is a memory runtime package for long-horizon agent systems.
...
### 6. Public API Surface (`mnemos/__init__.py`)
