...
This folder contains operational scripts for running MNEMOS locally: dependency setup (Neo4j), test gates, live end-to-end harnesses, evaluation wrappers, and cron-safe maintenance jobs.
