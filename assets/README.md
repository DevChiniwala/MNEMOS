...
`-- readme/
    ...
    |-- mnemos_package_images/           # package README generated image set
    |-- mnemos_package_svgs/             # package README animated SVG set
...
### Package README (`mnemos/README.md`)

- Uses `assets/readme/mnemos_package_images/*`
- Uses `assets/readme/mnemos_package_svgs/*`
